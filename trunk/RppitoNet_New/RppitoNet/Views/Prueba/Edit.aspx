<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<MvcApplication1.Models.NoticiaBE>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.Contenido) %>
...
<%--                <%: Html.TextBoxFor(model => model.Idseccion) %>
            ...
            <div class="editor-label">
                <%: Html.LabelFor(model => model.IdTipoNoticia) %>
            </div>
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.IdTipoNoticia) %>
                <%: Html.ValidationMessageFor(model => model.IdTipoNoticia) %>
            </div>
