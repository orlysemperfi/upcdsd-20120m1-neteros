<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<RppitoNet.Models.RegisterModel>" %>
    ...
    <% using (Html.BeginForm()) { %>
        ...
        <div>
            <fieldset>
                ...
                <p>
                    <input type="submit" val accesskeyue="Registrarse" />
                </p>
            </fieldset>
        </div>
    <% } %>
